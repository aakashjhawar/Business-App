...
class PartiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create party" do
    assert_difference('Party.count') do
      post parties_url, params: { party: { party_code: @party.party_code, party_name: @party.party_name } }
    end
  ...
  test "should update party" do
    patch party_url(@party), params: { party: { party_code: @party.party_code, party_name: @party.party_name } }
