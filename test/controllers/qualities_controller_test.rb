...
class QualitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quality" do
    assert_difference('Quality.count') do
      post qualities_url, params: { quality: { quality_name: @quality.quality_name, shade_no: @quality.shade_no } }
    end
  ...
  test "should update quality" do
    patch quality_url(@quality), params: { quality: { quality_name: @quality.quality_name, shade_no: @quality.shade_no } }
